...
loaded_localizations("zh-simplified", {
	...
	"Bitmaps must be greater than one pixel on a side.": "位图必须大于一个像素。",
	"Generic error.": "常规错误。",
	...
	"Draws a free-form line one pixel wide.": "用单像素线宽画任意形状的线条。",
	"Pencil": "铅笔",
	...
	"JS Paint Desktop": "JS Paint 桌面版",
	"Recover Document": "恢复文档",
	"Storage Error": "存储错误",
	"Tracky Mouse": "鼠标追踪",
	"Restore window": "恢复窗口",
	"Remove": "删除",
	"Press Esc to stop drawing randomly.": "按 Esc 键停止随机绘制。",
	"Speech not recognized.": "语音未被识别。",
	"Error occurred in speech recognition: ": "语音识别出现错误：",
	"To stop drawing, say \"stop drawing\", or press Esc.": "要停止绘制，请说\"停止绘制\"，或按 Esc 键。",
	"To stop drawing, press Esc.": "要停止绘制，请按 Esc 键。",
	"Failed to load clipart.": "加载剪贴画失败。",
	"Downloading picture...": "正在下载图片...",
	"Download complete.": "下载完成。",
	"Failed to download picture.": "下载图片失败。",
	"This isn't supposed to happen: Free-Form Select after Select in the tool chain?": "这不应该发生：工具链中自由选择在选择之后？",
	"Image dimensions too large for operation.": "图像尺寸过大，无法执行操作。",
	"Invalid transformation parameters.": "无效的变换参数。",
	"Invalid transformation result.": "无效的变换结果。",
	"Invalid output dimensions.": "无效的输出尺寸。",
	"Basic colors": "基本颜色",
	"Custom colors": "自定义颜色",
	"Define Custom Colors": "定义自定义颜色",
	"Color": "颜色",
	"Solid": "实心",
	"Add To Custom Colors": "添加到自定义颜色",
	"Recolor": "重新着色",
	"72 x 72 dots per inch": "72 x 72 每英寸",
	"Resolution:": "分辨率：",
	"Transparent": "透明",
	"Opaque": "不透明",
	"Hue": "色相",
